...
class Department {
    ...
    //use of static  keyword make us possible we no need to write new keyword to instantiate class. 
...
//protected access modifier can help us access or modify the method in parent